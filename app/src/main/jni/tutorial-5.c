...
static void *app_function (void *userdata) {
  ...
  /* Build pipeline */
  data->pipeline = gst_parse_launch("udpsrc multicast-group=224.1.1.1 auto-multicast=true port=9000 ! application/x-rtp,encoding-name=H264,payload=96 ! rtph264depay ! avdec_h264 ! videoconvert ! autovideosink", &error);
  if (error) {
